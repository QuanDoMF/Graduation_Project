      ...
      <section className='bg-secondary  py-20 px-4 md:px-6 lg:px-8'>
        <div className='max-w-4xl text-center'>
          ...
          <p className='mt-4 text-lg md:text-xl'>
            Địa chỉ: số 1, đường ABC, Quận 1, TP.Hà Nội, Việt Nam
          </p>
        </div>
      </section>
        ...
        <div className='max-w-4xl space-y-8'>
          <div>
            ...
            <p className='mt-4 text-muted-foreground leading-8'>
              DQ được thành lập vào năm 2010 với một sứ mệnh đơn giản: phục
          ...
          <div>
            ...
            <p className='mt-4 text-muted-foreground leading-8'>
              Tại trung tâm của DQ là sự cống hiến sâu sắc cho tính bền
